...
--Trigrama = CAO
CREATE TABLE CAREGORIAS_OCORRENCIAS(
	CAO_ID INT IDENTITY,
...
--Trigrama = IVA 
CREATE TABLE INVESTIGACOES_ACIDENTES(
	IVA_ID INT IDENTITY,
	IVA_STATUS VARCHAR(100) NOT NULL,
	IVA_OAC_ID INT NOT NULL,
	IVA_TPF_ID INT NOT NULL,
	IVA_AAS_ID INT NOT NULL,
	IVA_CDA_ID INT NOT NULL,
	IVA_FAC_ID INT NOT NULL,
	CONSTRAINT PK_IVA PRIMARY KEY (IVA_ID),
	CONSTRAINT FK_IVA_OAC FOREIGN KEY (IVA_OAC_ID) REFERENCES OCORRENCIAS_AERONAVES (OAC_ID),
	CONSTRAINT FK_IVA_TPF FOREIGN KEY (IVA_TPF_ID) REFERENCES TIPOS_FALHAS (TPF_ID),
	CONSTRAINT FK_IVA_AAS FOREIGN KEY (IVA_AAS_ID) REFERENCES ASPECTOS_ACIDENTES(AAS_ID),
	CONSTRAINT FK_IVA_CDA FOREIGN KEY (IVA_CDA_ID) REFERENCES CONDICIONANTES_ACIDENTES(CDA_ID),
	CONSTRAINT FK_IVA_FAC FOREIGN KEY (IVA_FAC_ID) REFERENCES FATORES_ACIDENTES(FAC_ID)
);

--Trigrama = RLI
CREATE TABLE RELATORIOS_INVESTIGACOES(
	RLI_ID INT IDENTITY,
	RLI_NUMERO VARCHAR(200) NOT NULL,
	RLI_DATA_PUBLICACACAO DATE NOT NULL,
	RLI_IVA_ID INT NOT NULL,
	CONSTRAINT PK_RLI PRIMARY KEY(RLI_ID),
	CONSTRAINT FK_RLI_IVA FOREIGN KEY (RLI_IVA_ID) REFERENCES INVESTIGACOES_ACIDENTES(IVA_ID)
);